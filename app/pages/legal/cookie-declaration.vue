<template>
  <div class="container mx-auto px-6 py-12 max-w-4xl">
    <div class="prose prose-gray dark:prose-invert max-w-none">
      <h1 class="font-clash text-4xl md:text-5xl font-semibold text-gray-900 dark:text-white mb-8">
        Cookie Policy
      </h1>
	    <br>
	    <p>
		    Effective Date: 21-May-2025 <br>
...
<script setup>
useHead({
  title: 'Cookie Policy - TradersYard',
  meta: [
    { name: 'description', content: 'Cookie policy explaining how TradersYard uses cookies and similar technologies on our website.' }
  ]
})
</script>